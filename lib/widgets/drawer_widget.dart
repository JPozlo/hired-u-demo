...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppTheme.mainScaffoldBackgroundColor.withOpacity(0.5),
      body: Column(
        ...
        children: <Widget>[
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: <BoxShadow>[
                                BoxShadow(color: AppTheme.mainCardBackgroundColor.withOpacity(0.6), offset: const Offset(2.0, 4.0), blurRadius: 8),
                              ],
                            ),
                            child: ClipRRect(
          ...
          Divider(
            height: 1,
            color: AppTheme.mainCardBackgroundColor.withOpacity(0.6),
          ),
          Expanded(
                ...
                children: <Widget>[
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 16,
                      color: widget.screenIndex == listData.index ? Colors.blue : AppTheme.mainCardBackgroundColor,
                    ),
                    textAlign: TextAlign.left,
                  ),
                ],
